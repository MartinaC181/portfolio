  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full h-full p-6 bg-background/80 backdrop-blur-sm border border-surface-200 rounded-2xl [backface-visibility:hidden] flex flex-col justify-center">
          ...
          {/* Espaciado entre columnas reducido a gap-x-8 */}
